...
class Type {
public:
  Type(std::string name, bool refTag = false, bool ptrTag = false);
  Type(std::vector<std::string> scope, std::string name, bool refTag = false, bool ptrTag = false);
  Type(std::string name, std::vector<Type> typeArgs, bool refTag = false, bool ptrTag = false);
  Type(std::vector<std::string> scope, std::string name,
    std::vector<Type> typeArgs, bool refTag = false, bool ptrTag = false);
  Type(std::vector<std::string> scope, std::string name, Type typeArg,
    bool refTag = false, bool ptrTag = false);
  Type(Type baseType, std::vector<Type> typeArgs, bool refTag = false, bool ptrTag = false);
  ~Type();
