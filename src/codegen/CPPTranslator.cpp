...
code::Expr* CPPTranslator::transDistribution(
  ...
  if (valuevar.empty()) {
    ...
    coreClsInit->addStmt(
        new code::CallExpr(
            new code::BinaryOperator(new code::Identifier(distvarname),
                new code::Identifier(DISTRIBUTION_INIT_FUN_NAME),
...
//    rd.push_back(new code::Identifier(RANDOM_ENGINE_VAR_NAME));
    return new code::CallExpr(
        new code::BinaryOperator(new code::Identifier(distvarname),
            new code::Identifier(DISTRIBUTION_GEN_FUN_NAME),
    ...
    return new code::CallExpr(
        new code::BinaryOperator(new code::Identifier(distvarname),
            new code::Identifier(DISTRIBUTION_LOGLIKELI_FUN_NAME),
            code::OpKind::BO_FIELD), args);
  }
}
...
void CPPTranslator::transQuery(code::FunctionDecl* fun,
  ...
  fun->addStmt(
      new code::CallExpr(
          new code::BinaryOperator(new code::Identifier(answervarname),
              new code::Identifier(HISTOGRAM_ADD_METHOD_NAME),
              code::OpKind::BO_FIELD), args));
  ...
  coreClsPrintFun->addStmt(
                           new code::CallExpr(
                                              new code::BinaryOperator(new code::Identifier(answervarname),
                                                                       new code::Identifier(HISTOGRAM_PRINT_METHOD_NAME),
                                                                       code::OpKind::BO_FIELD))
  );
}
