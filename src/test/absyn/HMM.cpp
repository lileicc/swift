  ...
  */
  {
    ...
    { // Else Clause
      ...
      FuncApp *cat_A = new FuncApp(0, 0, Symbol("Categorical"));
      cat_A->add(map_A);
      ...
      FuncApp *cat_C = new FuncApp(0, 0, Symbol("Categorical"));
      cat_C->add(map_C);
      ...
      FuncApp *cat_G = new FuncApp(0, 0, Symbol("Categorical"));
      cat_G->add(map_G);
      ...
      FuncApp *cat_T = new FuncApp(0, 0, Symbol("Categorical"));
      cat_T->add(map_T);
