...
void Hurricane::build(){
	...
	*/
	{
		SetExpr *se = new SetExpr(0, 0, new Symbol("City"), new Symbol("c"));
	...
	*/
	{
		...
		ObsDecl *obs = new ObsDecl(0, 0, dam, new VarRef(0, 0, Symbol("Severe")));
		blog->add(obs);
	}
	/*
	query First;
